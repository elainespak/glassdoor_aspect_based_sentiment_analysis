...
if __name__ == "__main__":
    ...
    epochs = 3
    kind = 'all'
    #FINE_TUNED_MODEL_NAME = f'C:/Users/elain/Desktop/glassdoor_aspect_based_sentiment_analysis/sentence_classification/{aspect}_{kind}_epoch{str(epochs)}/'
    ...
    #attribution_model.sentclass_pos_forward_func()
    ...
    print(f'Predicted Answer: {torch.argmax(logits[0])} vs. Gold: {ground_truth}')
    for t, a in zip(all_tokens, attributions_start_sum.detach().tolist()):
        print(t + '\t\t' + str(a))

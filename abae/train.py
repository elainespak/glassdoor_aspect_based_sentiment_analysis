...
#parser.add_argument("-as", "--aspect-size", dest="aspect_size", type=int, metavar='<int>', default=7, help="The number of aspects specified by users (default=7)")
...
vocab, train_x, test_x, overall_maxlen = dataset.get_data(args.domain, 'test', vocab_size=args.vocab_size, maxlen=args.maxlen)
